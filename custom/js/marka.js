...
$(document).ready(function() {
	...
	$("#submitBrandForm").unbind('submit').bind('submit', function() {
		...
		if(brandName == "") {
			$("#brandName").after('<p class="text-danger">Marka adi bos birakilamaz.</p>');
		...
		if(brandStatus == "") {
			$("#brandStatus").after('<p class="text-danger">Marka durumu bos birakilamaz.</p>');
	...
	if(brandId) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$('#editBrandName').val(response.marka_ad);
				// setting the brand status value
				$('#editBrandStatus').val(response.marka_etkin);
				// brand id 
				$(".editBrandFooter").after('<input type="hidden" name="brandId" id="brandId" value="'+response.marka_id+'" />');
				...
				$('#editBrandForm').unbind('submit').bind('submit', function() {
					...
					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">Marka adi bos birakilamaz.</p>');
					...
					if(brandStatus == "") {
						$("#editBrandStatus").after('<p class="text-danger">Marka durumu bos birakilamaz.</p>');
...
function removeBrands(brandId = null) {
	if(brandId) {
		...
		$.ajax({
			...
			dataType: 'json',
			success:function(response) {
				$('.removeBrandFooter').after('<input type="hidden" name="removeBrandId" id="removeBrandId" value="'+response.marka_id+'" /> ');
