...
$(document).ready(function() {
	...
	$('#addCategoriesModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitCategoriesForm").unbind('submit').bind('submit', function() {
			...
			if(categoriesName == "") {
				$("#categoriesName").after('<p class="text-danger">Kategori adi bos birakilamaz.</p>');
			...
			if(categoriesStatus == "") {
				$("#categoriesStatus").after('<p class="text-danger">Kategori durumu bos birakilamaz.</p>');
	...
	if(categoriesId) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#editCategoriesName").val(response.kategori_ad);
				// set the categories status
				$("#editCategoriesStatus").val(response.kategori_etkin);
				// add the categories id 
				$(".editCategoriesFooter").after('<input type="hidden" name="editCategoriesId" id="editCategoriesId" value="'+response.kategori_id+'" />');
				...
				$("#editCategoriesForm").unbind('submit').bind('submit', function() {
					...
					if(categoriesName == "") {
						$("#editCategoriesName").after('<p class="text-danger">Kategori adi bos birakilamaz.</p>');
					...
					if(categoriesStatus == "") {
						$("#editCategoriesStatus").after('<p class="text-danger">Kategori durumu bos birakilamaz.</p>');
